...
- Name: export-pdf.spec.ts >> navegar a la página de exportación y seleccionar un template
- Location: e2e/export-pdf.spec.ts:51:1
...
Locator: getByText('Exportar PDF')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Exportar PDF')
